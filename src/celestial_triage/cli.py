...
def build_export_rows(
    ...
    for cid in db.list_candidate_ids():
        ...
        row = {
            ...
            "motion_state": context.get("motion_state", "insufficient data"),
            "motion_anomaly_flag": bool(context.get("motion_anomaly_flag", False)),
            "motion_anomaly_score": float(context.get("motion_anomaly_score", 0.0) or 0.0),
            "motion_anomaly_reason": context.get("motion_anomaly_reason", ""),
            "motion_avg_velocity_arcsec_per_sec": float(context.get("motion_avg_velocity_arcsec_per_sec", 0.0) or 0.0),
            "motion_total_time_span_sec": float(context.get("motion_total_time_span_sec", 0.0) or 0.0),
            "motion_angular_displacement_arcsec": float(context.get("motion_angular_displacement_arcsec", 0.0) or 0.0),
    ...
    if args.format == "csv":
        ...
        _write_rows(
            ...
            fieldnames=[
                ...
                "motion_anomaly_reason",
                "motion_avg_velocity_arcsec_per_sec",
                "motion_total_time_span_sec",
                "motion_angular_displacement_arcsec",
